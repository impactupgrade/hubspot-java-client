...
data class ImportsResponse(
  var results: List<ImportResponse>? = null
)
...
data class ImportCancelResponse(
  var status: String? = null,
  var requestedAt: Calendar? = null,
  var startedAt: Calendar? = null,
  var completedAt: Calendar? = null,
